    ...
    <%@ taglib prefix="c" uri="jakarta.tags.core" %>
        ...
        <body>
            <div class="container">
                <!-- Devonxjz Logo -->
                <div class="logo">
                    <img src="${pageContext.request.contextPath}/assets/images/logo.jpg" alt="Devonxjz Logo" width="72"
                        height="72">
                </div>
                ...
                <form action="${pageContext.request.contextPath}/survey" method="get">
                    ...
                    <h2 class="section-heading">Would you like to receive announcements<br>about new CDs and special
                        offers?
                    </h2>
                    <div class="checkbox-group">
                        <label class="checkbox-label">
                            <input type="checkbox" name="wantsUpdates" value="YES, I'd like that."> YES, I'd like that.
                        </label>
                        <label class="checkbox-label">
                            <input type="checkbox" name="emailAnnouncements"
                                value="YES, please send me email announcements.">
                ...
                <%-- Bạn cũng có thể dùng thẻ JSP Action: <jsp:include page="/footer.jsp" /> --%>
